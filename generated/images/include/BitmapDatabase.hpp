...
const uint16_t BITMAP_BLUE_ICONS_DOWN_ARROW_32_ID = 5;
const uint16_t BITMAP_BLUE_ICONS_NEXT_ARROW_32_ID = 6;
const uint16_t BITMAP_BLUE_ICONS_UP_ARROW_32_ID = 7;
